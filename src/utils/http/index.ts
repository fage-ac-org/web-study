...
import type { PureHttpError, RequestMethods, PureHttpResponse, PureHttpRequestConfig } from './types'
    ...
    return new Promise((resolve, reject) => {
      PureHttp.axiosInstance
        ...
        .then((response: AxiosResponse | T) => {
          if (response && typeof response === 'object' && 'data' in (response as AxiosResponse)) {
            resolve((response as AxiosResponse<T>).data)
          } else {
